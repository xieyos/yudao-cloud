...
public class CombinationRecordBaseVO {
    ...
    @Schema(description = "用户昵称", example = "老xieyos")
    private String nickname;

    @Schema(description = "用户头像", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.qtvz.com/xxx.jpg")
    ...
    @Schema(description = "商品图片", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.qtvz.com/1.png")
