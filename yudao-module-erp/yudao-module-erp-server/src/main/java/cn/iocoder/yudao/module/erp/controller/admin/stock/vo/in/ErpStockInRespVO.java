...
public class ErpStockInRespVO {
    ...
    @Schema(description = "供应商名称", example = "xieyos")
    @ExcelProperty("供应商名称")
    ...
    @Schema(description = "附件 URL", example = "https://www.qtvz.com/1.doc")
    private String fileUrl;

    @Schema(description = "创建人", example = "xieyos")
    private String creator;
    @Schema(description = "创建人名称", example = "xieyos")
