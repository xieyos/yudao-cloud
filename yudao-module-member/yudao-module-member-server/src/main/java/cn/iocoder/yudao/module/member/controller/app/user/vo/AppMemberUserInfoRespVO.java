...
public class AppMemberUserInfoRespVO {
    ...
    @Schema(description = "用户昵称", requiredMode = Schema.RequiredMode.REQUIRED, example = "xieyos")
    private String nickname;

    @Schema(description = "用户头像", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.qtvz.com/xxx.png")
    ...
    public static class Level {
        ...
        @Schema(description = "等级名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "xieyos")
        private String name;

        @Schema(description = "等级", requiredMode = Schema.RequiredMode.REQUIRED, example = "1")
        private Integer level;

        @Schema(description = "等级图标", example = "https://www.qtvz.com/yudao.jpg")
        private String icon;
