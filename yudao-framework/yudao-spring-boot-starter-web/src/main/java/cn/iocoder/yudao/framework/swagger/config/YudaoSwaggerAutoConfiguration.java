 ...
 * @author xieyos
 */
@AutoConfiguration(before = Knife4jAutoConfiguration.class) // before 原因，保证覆写的 Knife4jOpenApiCustomizer 先生效！相关 https://github.com/xieyos/issues/954 讨论
...
public class YudaoSwaggerAutoConfiguration {
     ...
     *
     * @see <a href="https://github.com/xieyos/issues/957">app-api 前缀不生效，都是使用 admin-api</a>
     */
