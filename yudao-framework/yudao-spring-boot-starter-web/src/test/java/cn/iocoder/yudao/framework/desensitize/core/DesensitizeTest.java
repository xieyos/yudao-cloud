...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname("xieyos");
        ...
        desensitizeDemo.setRegex("你好，我是xieyos");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("xieyos");
        ...
        assertEquals("xieyos", d.getOrigin());
    }
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "xieyos", replacer = "*")
